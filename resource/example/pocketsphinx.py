#!/usr/bin/env python
# from http://cmusphinx.sourceforge.net/wiki/gstreamer
...
class DemoApp(object):
    ...
    def __init__(self, ps_lm, ps_dict):
...
def main():
    parser = argparse.ArgumentParser(description='Print what I say')
    parser.add_argument('--lm', default=None)
    parser.add_argument('--dict', default=None)
    args = parser.parse_args()

    app = DemoApp(args.lm, args.dict)
    gtk.main()
